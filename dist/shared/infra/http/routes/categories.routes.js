...
categoriesRoutes.post("/", _ensureAuthenticated.ensureAuthenticate, _ensureAdmin.ensureAdmin, createCategoryController.handle);
categoriesRoutes.get("/", listCategoriesController.handle);
categoriesRoutes.post("/import", upload.single("file"), _ensureAuthenticated.ensureAuthenticate, _ensureAdmin.ensureAdmin, importCategoryController.handle);
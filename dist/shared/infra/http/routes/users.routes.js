...
usersRoutes.patch("/avatar", _ensureAuthenticated.ensureAuthenticate, uploadAvatar.single("avatar"), updateUserAvatarController.handle);
usersRoutes.get("/profile", _ensureAuthenticated.ensureAuthenticate, profileUserController.handle);
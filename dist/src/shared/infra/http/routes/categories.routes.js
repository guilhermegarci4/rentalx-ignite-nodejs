...
categoriesRoutes.post("/", ensureAuthenticated_1.ensureAuthenticate, ensureAdmin_1.ensureAdmin, createCategoryController.handle);
categoriesRoutes.get("/", listCategoriesController.handle);
categoriesRoutes.post("/import", upload.single("file"), ensureAuthenticated_1.ensureAuthenticate, ensureAdmin_1.ensureAdmin, importCategoryController.handle);

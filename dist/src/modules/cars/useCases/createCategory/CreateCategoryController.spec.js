    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    password = _a.sent();
                    return [4 /*yield*/, connection.query("INSERT INTO USERS(id, name, email, password, \"isAdmin\", created_at, driver_license, avatar) \n                values('" + id + "', 'admin', 'admin@rentx.com.br', '" + password + "', true, 'now()', 'XXXXXX', 'null')\n            ")];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, supertest_1.default(app_1.app).post("/categories")
                            .send({
